...
const ModalUpdate = ({users, getDateUser}) => {
    ...
    const getUserById = async () => {
        ...
        .then((json) => {
            ...
            setUser_username(data.user_username);
            setUser_name(data.user_name);
            setUser_email(data.user_email);
            setUser_alamat(data.user_alamat);
            setUser_notelp(data.user_notelp);
    ...
    const handleFormUpdateData = async (e) => {
        ...
        .then(() => {
            ...
            alert('Update data User successfully');
            ...
            <div className='modal-box'>
                ...
                <div className='modal-form'>
                    <form action='#' onSubmit={handleFormUpdateData}>
                        ...
                        <button type='submit' className='add-data'>Update Data user</button>
                    </form>
                </div>
            </div>
